...
#move_lines = models.execute_kw(ODOO_DB, uid, ODOO_PASSWORD, 'stock.picking', 'create', [{
	#'name': 'phone',
#	'company_id': uid, 
#	'location_dest_id': 'https://eiffel1.odoo.com/web?debug#id=14&view_type=form&model=stock.location&menu_id=',
#	'location_id': 'https://eiffel1.odoo.com/web?debug#id=8&view_type=form&model=stock.location&menu_id=',
#	'move_type': 'direct',
#	}])

#pick_id = models.execute_kw(ODOO_DB, uid, ODOO_PASSWORD,'stock.picking', 'search',
 #   [[['name', '=', 'WH/OUT/00002']]])
...
'move_type':'direct',
'location_id':uid,
'location_dest_id':uid,
'picking_type_id': '0003',
	}])
